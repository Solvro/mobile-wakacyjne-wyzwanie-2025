...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/bali.jpg
  ...
  /// File path: assets/images/tokio.png
  AssetGenImage get tokio => const AssetGenImage('assets/images/tokio.png');

  /// List of all assets
  List<AssetGenImage> get values => [bali, nowyJork, santorini, sycylia, tokio];
}

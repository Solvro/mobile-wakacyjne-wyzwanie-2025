...
class PlaceScreenList extends StatelessWidget {
  final List<Place> places = [
    Place(
      ...
      placeName:
          Center(child: const Text('Snowdin', style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold))),
    ...
    Place(
      ...
      placeName:
          Center(child: const Text('Kryvyi Rih', style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold))),
    ...
    Place(
      ...
      placeName:
          Center(child: const Text('Zakopane', style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold))),
    ...
    Place(
      ...
      placeName:
          Center(child: const Text('Las Vegas', style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold))),
    ...
    Place(
      ...
      placeName:
          Center(child: const Text('Pentagon', style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold))),
      ...
      feature3: Column(
          children: const [Icon(Icons.build_circle), Text('5 aboveground floors,\nand 2 underground,\nofficially')]),
    ),
  ];
    ...
    return Scaffold(
      ...
      body: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return InkWell(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (_) => DreamPlaceScreen(place: place)));
                },
                child: Card(
